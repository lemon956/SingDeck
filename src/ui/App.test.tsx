...
describe('App proxy workspace', () => {
  ...
  it('shows provider traffic as total, used, reset date, and payment time', () => {
    ...
    expect(screen.getByRole('button', { name: /Filter strategy group wd/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /Filter strategy group xnyun/i })).toBeInTheDocument();
    fireEvent.click(screen.getByRole('button', { name: /Filter strategy group wd/i }));
    expect(screen.getByRole('button', { name: /Filter strategy group wd/i })).toHaveAttribute('aria-pressed', 'true');
    fireEvent.click(screen.getByRole('button', { name: /Filter strategy group wd/i }));
    expect(screen.getByRole('button', { name: /Filter strategy group wd/i })).toHaveAttribute('aria-pressed', 'false');
    fireEvent.click(screen.getByRole('button', { name: /Refresh strategy group trend/i }));
